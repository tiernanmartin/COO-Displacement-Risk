...
if(!file.exists(root_file('1-data/4-interim/prcl-all-2014-pt-geoid-sf.rds'))){
        ...
        prcl_all_2014_pt_sp <- prcl_all_2014_pt_sf %>% as("Spatial")
        ...
        prcl_over_geoid <- over(prcl_all_2014_pt_sp,tr_kc_sp)
        
        # Join the GEOID column to the parcel sf object
        
        prcl_all_2014_pt_geoid_sf <-
                prcl_all_2014_pt_sf %>% 
        ...
        prcl_all_2014_pt_geoid_sf %>% write_rds(root_file('1-data/4-interim/prcl-all-2014-pt-geoid-sf.rds'))
}

prcl_all_2014_pt_geoid_sf  <- read_rds(root_file('1-data/4-interim/prcl-all-2014-pt-geoid-sf.rds'))
