...
print_paged_sf(acs_2009_sf)
```


#### Census Tables, 2011-2015
```{r census-show-2010-table}
print_paged_sf(acs_2015_sf)
```
...
acs_2009_sf %>% select(NAME_FULL,GEOID6,ENDYEAR,B03002_003) %>% slice(3) %>% print_paged_sf()
```
