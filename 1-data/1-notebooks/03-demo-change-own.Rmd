...
```{r demo-chng-own-setup, echo = FALSE, warning=FALSE,message=FALSE,comment=FALSE}
library(plyr)
library(scales)
library(knitr)
library(rprojroot)
...
make_acs_crosstalk(long_sf = map_acs_data_sf,
             ...
             .topic = 'B25033',
             .pal = div_pal,
             .legend_title = "CHANGE IN<br>% OWNED HU's<hr>2005-2009<br>TO<br>2011-2015",
             .height_lflt = 600,
             .height_pltly_upper = 200,
             .height_pltly_lower = 400,
             .width_pltly = 400,
             .plotly_title = "CHANGE IN % OWNED HU's",
             zoom = 9)
```

##### COO Communities {-}
```{r demo-chng-own-comm-map, fig.height=3, fig.width=2,  fig.show='hold', dpi=150}
...
make_acs_dt(long_sf = map_acs_data_sf,
            .category = 'DEMO',
            .topic = 'B25033',
            .col_title = "Change in Pop. in Owned HU's")
