...
stc_hus <- read_csv(root_file("1-data/3-external/seatac_hus/DEC_10_SF1_H1_with_ann.csv"), 
...
```{r, echo=FALSE,message=FALSE,warning = FALSE,fig.height=1.25, fig.width=1,  fig.show='hold', dpi=150,fig.cap='Rainier Valley, White Center, and SeaTac/Tukwila'}
...
if(!file.exists(root_file('1-data/4-interim/tr_trim_sp.gpkg'))){
        writeOGR(obj = tr_trim_sp,
         dsn = root_file('1-data/4-interim/tr_trim_sp.gpkg'),
...
hra <- readOGR(dsn = root_file('1-data/3-external/HRA_2010Block_Clip/'),
