...
par(mar = c(1,4,1,1))
plot(chng_bach_2014_acs[order(estimate(chng_bach_2014_acs)),1],ylab = 'Share of Adults with at least a BA (%)',yaxt = 'n',xaxt = 'n',bty = 'n')
yticks_val <- scales::pretty_breaks(n=5)(chng_bach_2014_acs@estimate)
yticks <- scales::pretty_breaks(n=5)(chng_bach_2014_acs@estimate)
...
chng_bach_2009_noUW_acs <- chng_bach_2009_acs[standard.error(chng_bach_2009_acs)<.5,]
