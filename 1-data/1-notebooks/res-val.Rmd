...
res_val_csv <- read_csv("~/Documents/FW/COO/COO-Displacement-Risk/1-data/3-external/EXTR_RealPropApplHist_V.csv",
...
The following data transformations need to be completed in order to for this data to be useful for this project:
  ...
  * exclude years that are not either 2005, 2010, or 2015
