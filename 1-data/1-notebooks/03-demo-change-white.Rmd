...
```{r demo-chng-white-setup, echo = FALSE, warning=FALSE,message=FALSE,comment=FALSE}
library(plyr)
library(scales)
library(knitr)
library(rprojroot)
...
make_acs_crosstalk(long_sf = map_acs_data_sf,
             ...
             .topic = 'B03002',
             .pal = div_pal,
             .legend_title = "CHANGE IN<br>% WHITE<hr>2005-2009<br>TO<br>2011-2015",
             .height_lflt = 600,
             .height_pltly_upper = 200,
             .height_pltly_lower = 400,
             .width_pltly = 400,
             .plotly_title = "CHANGE IN % WHITE",
             zoom = 9)
```

##### COO Communities {-}
```{r demo-chng-white-comm-map, fig.height=3, fig.width=2,  fig.show='hold', dpi=150}
...
```{r demo-chng-white-dt}

make_acs_dt(long_sf = map_acs_data_sf,
            .category = 'DEMO',
            .topic = 'B03002',
            .col_title = "Change in Whites")
