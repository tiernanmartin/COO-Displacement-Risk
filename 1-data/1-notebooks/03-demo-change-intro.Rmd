...
##### SEACCD {-}
  * The white population share either increased or it decreased less than **`r inds_seaccd[['race_DEMO_CHNG']]`**  `r sprk[['race_DEMO_SEACCD']]`
  * The share of homeowners either increased more than **`r inds_seaccd[['housing_DEMO_CHNG']]`**  `r sprk[['housing_DEMO_SEACCD']]`
  * The share of the population 25 years and older with a bachelor’s degree increased more than **`r inds_seaccd[['ed_DEMO_CHNG']]`**  `r sprk[['ed_DEMO_SEACCD']]`
  * The share of household earning more than 80% AMI increased or it decreased less than **`r inds_seaccd[['income_DEMO_CHNG']]`**  `r sprk[['income_DEMO_SEACCD']]`

##### King County {-}
  * The white population share either increased or it decreased less than **`r inds_kc[['race_DEMO_CHNG']]`**  `r sprk[['race_DEMO_KC']]`
  * The share of homeowners either increased more than **`r inds_kc[['housing_DEMO_CHNG']]`**  `r sprk[['housing_DEMO_KC']]`
  * The share of the population 25 years and older with a bachelor’s degree increased more than **`r inds_kc[['ed_DEMO_CHNG']]`**  `r sprk[['ed_DEMO_KC']]`
  * The share of household earning more than 80% AMI increased or it decreased less than **`r inds_kc[['income_DEMO_CHNG']]`**  `r sprk[['income_DEMO_KC']]`


##### COO Baselines: Seattle Subdivision vs King County {-}
```{r demo-change-lgl-map, fig.height=3, fig.width=2,  fig.show='hold', dpi=150}
...
make_acs_map(long_sf = map_acs_lgl_typo_data_sf,
             ...
             .pal = new_spectral,
             .pal_type = 'factor',
             .legend_title = "Demographic<br>Change<br>Tract<br>(SEACCD)",
...
make_acs_map(long_sf = map_acs_lgl_typo_data_sf,
             ...
             .pal = new_spectral,
             .pal_type = 'factor',
             .legend_title = "Demographic<br>Change<br>Tract<br>(KC)",
