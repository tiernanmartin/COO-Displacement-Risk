...
##### King County {-}
  * The white population share either increased or it decreased less than **`r inds_kc[['race_DEMO_CHNG']]`**
  * The share of homeowners either increased more than **`r inds_kc[['housing_DEMO_CHNG']]`**
  * The share of the population 25 years and older with a bachelor’s degree increased more
than **`r inds_kc[['ed_DEMO_CHNG']]`**
  * The share of household earning more than 80% AMI increased or it decreased less than **`r inds_kc[['income_DEMO_CHNG']]`**
